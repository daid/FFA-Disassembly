...
.loop:
    ...
    pop  BC                                            ;; 02:47ad $c1
    dec  B                                             ;; 02:47ae $05
    jr   NZ, call_02_478e.loop                         ;; 02:47af $20 $e8
    ret                                                ;; 02:47b1 $c9
...
.loop_1:
    ...
    inc  DE                                            ;; 02:6966 $13
    dec  B                                             ;; 02:6967 $05
    jr   NZ, jp_02_6943.loop_1                         ;; 02:6968 $20 $fa
    xor  A, A                                          ;; 02:696a $af
    ld   [HL], A                                       ;; 02:696b $77
...
.loop_2:
    ld   [HL+], A                                      ;; 02:6971 $22
    dec  B                                             ;; 02:6972 $05
    jr   NZ, jp_02_6943.loop_2                         ;; 02:6973 $20 $fc
    pop  AF                                            ;; 02:6975 $f1
    pop  BC                                            ;; 02:6976 $c1
    pop  DE                                            ;; 02:6977 $d1
    pop  HL                                            ;; 02:6978 $e1
...
.loop:
    ...
    inc  HL                                            ;; 02:7a5b $23
    dec  B                                             ;; 02:7a5c $05
    jr   NZ, call_02_7a4e.loop                         ;; 02:7a5d $20 $f6
    pop  BC                                            ;; 02:7a5f $c1
    pop  HL                                            ;; 02:7a60 $e1
    ret                                                ;; 02:7a61 $c9
.jr_02_7a62:
...
.loop:
    ld   [HL+], A                                      ;; 02:7ba9 $22
    dec  B                                             ;; 02:7baa $05
    jr   NZ, jp_02_7b9f.loop                           ;; 02:7bab $20 $fc
