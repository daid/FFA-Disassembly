...
call_0f_40a7:
    ...
    ld   A, [HL+]                                      ;; 0f:40b8 $2a
    ld   [wMusicInstructionPointerLow], A              ;; 0f:40b9 $ea $04 $c1
    ld   A, [HL+]                                      ;; 0f:40bc $2a
    ld   [wMusicInstructionPointerHigh], A             ;; 0f:40bd $ea $05 $c1
    ld   A, [HL+]                                      ;; 0f:40c0 $2a
...
call_0f_4386:
    ...
    ld   A, E                                          ;; 0f:439e $7b
    ld   [wMusicInstructionPointerLow], A              ;; 0f:439f $ea $04 $c1
    ld   A, D                                          ;; 0f:43a2 $7a
...
call_0f_43a7:
    ...
    ld   A, [DE]                                       ;; 0f:43ad $1a
    inc  DE                                            ;; 0f:43ae $13
    ld   [wMusicInstructionPointerLow], A              ;; 0f:43af $ea $04 $c1
    ld   A, [DE]                                       ;; 0f:43b2 $1a
...
call_0f_442a:
    ...
    ld   L, A                                          ;; 0f:4431 $6f
    ld   A, [wMusicInstructionPointerHigh]             ;; 0f:4432 $fa $05 $c1
    ld   H, A                                          ;; 0f:4435 $67
    ld   A, [HL+]                                      ;; 0f:4436 $2a
    ld   E, A                                          ;; 0f:4437 $5f
    ld   A, [HL+]                                      ;; 0f:4438 $2a
...
call_0f_449b:
    ...
    ld   A, E                                          ;; 0f:44b3 $7b
    ld   [wMusicInstructionPointerLow], A              ;; 0f:44b4 $ea $04 $c1
    ld   A, D                                          ;; 0f:44b7 $7a
