...
script_0007:
    ...
    db  $f0 ;;UNK_F0_DELAY?                            ;; 0d:4150 $f0
    db   $05                                           ;; 0d:4151 .
    db  $87 ;;SET_PLAYER_DIRECTION_LEFT                ;; 0d:4152 $87
    db  $f0 ;;UNK_F0_DELAY?                            ;; 0d:4153 $f0
    db   $05                                           ;; 0d:4154 .
...
script_000d:
    ...
    db  $f0 ;;UNK_F0_DELAY?                            ;; 0d:4394 $f0
    db   $1e                                           ;; 0d:4395 ?
    db  $04 ;;MSG                                      ;; 0d:4396 $04
    db   $f1, $00                                      ;; 0d:4397 ??
    db  $f0 ;;UNK_F0_DELAY?                            ;; 0d:4399 $f0
    db   $14                                           ;; 0d:439a ?
...
script_019d:
    ...
    db   $35, $00                                      ;; 0d:4c90 ??
    db  $f0 ;;UNK_F0_DELAY?                            ;; 0d:4c92 $f0
    db   $1e                                           ;; 0d:4c93 ?
    db  $04 ;;MSG                                      ;; 0d:4c94 $04
    db   $35, $f1, $00                                 ;; 0d:4c95 ???
    db  $f0 ;;UNK_F0_DELAY?                            ;; 0d:4c98 $f0
    db   $32                                           ;; 0d:4c99 ?
...
script_01bd:
    ...
    db  $f0 ;;UNK_F0_DELAY?                            ;; 0d:53eb $f0
    db   $64                                           ;; 0d:53ec ?
    db  $04 ;;MSG                                      ;; 0d:53ed $04
    db   $1b, $14, $f5, $f1, $00                       ;; 0d:53ee ?????
    db  $f0 ;;UNK_F0_DELAY?                            ;; 0d:53f3 $f0
    db   $64                                           ;; 0d:53f4 ?
    db  $04 ;;MSG                                      ;; 0d:53f5 $04
    db   $f1, $00                                      ;; 0d:53f6 ??
    db  $f0 ;;UNK_F0_DELAY?                            ;; 0d:53f8 $f0
    db   $3c                                           ;; 0d:53f9 ?
...
script_01f9:
    ...
    db   $2d, $00, $07                                 ;; 0d:5d21 ???
    db  $80 ;;WAIT_PLAYER_WALK_DONE                    ;; 0d:5d24 $80
    db  $80 ;;WAIT_PLAYER_WALK_DONE                    ;; 0d:5d25 $80
...
script_022a:
    ...
    db   $1a, $00                                      ;; 0d:6abc ..
    db  $f0 ;;UNK_F0_DELAY?                            ;; 0d:6abe $f0
    db   $28                                           ;; 0d:6abf .
    db  $04 ;;MSG                                      ;; 0d:6ac0 $04
    db   $ff, $f1, $00                                 ;; 0d:6ac1 ...
    db  $f0 ;;UNK_F0_DELAY?                            ;; 0d:6ac4 $f0
    db   $32                                           ;; 0d:6ac5 .
    db  $04 ;;MSG                                      ;; 0d:6ac6 $04
    db   $ff, $f1, $00                                 ;; 0d:6ac7 ...
    db  $f0 ;;UNK_F0_DELAY?                            ;; 0d:6aca $f0
    db   $1e                                           ;; 0d:6acb .
